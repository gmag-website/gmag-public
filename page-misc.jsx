  ...
  return (
    <main data-screen-label="حمایت از گوسان">
      ...
      <div className="wrap" style={{ maxWidth: '760px', paddingBottom: '5rem' }}>
        <Reveal>
          <p style={para}>
            گوسان تنها با پشتیبانی خوانندگان سر پا می‌ماند. قلم‌بهای نویسندگان و پژوهشگران، دستمزد تحریریه و هزینه‌های فنی، همه از همین راه تأمین می‌شود. آگهی و بودجهٔ نهادی در کار نیست؛ حامیان در محتوا دستی ندارند و یافته‌های گوسان را همراه با همگان، پس از انتشار می‌خوانند.
          </p>
