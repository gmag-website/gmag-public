    ...
    <main data-screen-label="حمایت از گوسان">
      ...
      <div className="wrap" style={{ maxWidth: '760px', paddingBottom: '5rem' }}>
        <Reveal>
          ...
          <p style={para}>
            پشتیبانی یاران سهمی است در ماندگاری نهادی که دوستش دارند. محتوای گوسان برای همه آزاد می‌ماند و این پشتیبانی امتیازی به همراه ندارد؛ گوسان قدر آن را می‌داند و سپاس خود را به شیوه‌های شایسته به جا می‌آورد.
          </p>
