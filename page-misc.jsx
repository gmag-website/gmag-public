    ...
    <main data-screen-label="حمایت از گوسان">
      ...
      <div className="wrap" style={{ maxWidth: '760px', paddingBottom: '5rem' }}>
        <Reveal>
          ...
          <p style={para}>
            یار گوسان بودن، سهم داشتن در ماندگاری نهادی است که خواندنش را دوست دارند. آنچه گوسان منتشر می‌کند بر همگان گشوده است و پشتیبانی در آن حق و امتیازی پدید نمی‌آورد؛ گوسان این همراهی را از یاد نمی‌برد.
          </p>
