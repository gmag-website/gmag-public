  ...
  return (
    <main data-screen-label="حمایت از گوسان">
      ...
      <div className="wrap" style={{ maxWidth: '760px', paddingBottom: '5rem' }}>
        <Reveal>
          <p style={para}>
            گوسان تنها با پشتیبانی خوانندگان سر پا می‌ماند. قلم‌بهای نویسندگان و پژوهشگران، دستمزد تحریریه و هزینه‌های فنی، همه از همین راه تأمین می‌شود. گوسان آگهی و بودجهٔ نهادی نمی‌پذیرد؛ حامیان در محتوا دستی ندارند و محتوای گوسان را همراه با همگان، پس از انتشار می‌خوانند.
          </p>

          <div style={{ border: '1px solid var(--gold)', padding: '1rem 1.3rem', margin: '1.4rem 0' }}>
            <p style={{ ...note, margin: 0 }}>
              انجمن گوسان (Gōsān Institute e. V. i. Gr.) در آستانهٔ ثبت رسمی در برلین است. پذیرش کمک‌های مالی با ثبت انجمن و گشایش حساب بانکی آغاز می‌شود؛ این صفحه راه‌های آن را از هم‌اکنون پیش رو می‌گذارد.
            </p>
          </div>
          ...
          <p style={para}>
            هر نهاد فرهنگی و پژوهشی که ماندگار شده، حلقه‌ای از یاران آن را بر پا نگه داشته است.
          </p>
          <p style={para}>
            یار گوسان بودن، سهم داشتن در ماندگاری نهادی است که خواندنش را دوست دارند. آنچه گوسان منتشر می‌کند بر همگان گشوده است و پشتیبانی در آن حق و امتیازی پدید نمی‌آورد؛ سپاس گوسان از یاران، به شیوه‌هایی در خور این همراهی، ادا می‌شود.
          </p>
          ...
          <p style={note}>
            پرداخت از راه PayPal یا دستور بانکی، با راه‌اندازی رسمی گشوده می‌شود. هر پرداخت یک‌باره است و خودبه‌خود تکرار نمی‌شود؛ هر گاه بخواهید، می‌توانید دوباره همراه شوید.
          </p>
          ...
          <p style={note}>
            از هر جای اروپا و جهان می‌توان به گوسان کمک کرد: انتقال بانکی (در منطقهٔ یورو با SEPA و بی‌هزینه)، یا پرداخت با PayPal و کارت بانکی. بنا بر حقوق اتحادیهٔ اروپا، کمک به نهادهای عام‌المنفعهٔ یک کشور عضو می‌تواند در کشور محل اقامت حامی از مالیات کسر شود؛ گوسان پس از تأیید عام‌المنفعگی، اسناد لازم را در اختیار حامیانی می‌گذارد که بخواهند از این راه بهره ببرند. برای کمک‌های کلان از دیگر کشورهای اروپایی، راه گواهی مالیاتی محلی از شبکهٔ Transnational Giving Europe بررسی و همین‌جا اعلام خواهد شد.
          </p>

          <div style={label}>حامیان در آمریکا · U.S. Donors</div>
          <p style={note}>
            از آمریکا می‌توان با کارت بانکی و PayPal کمک کرد. کسر مالیاتی آمریکا (tax-deductible) هنوز برقرار نیست؛ پس از تأیید عام‌المنفعگی، راه کمکی که در آمریکا از مالیات کسر شود، از صندوق دوستان آمریکایی (American Friends Fund) گشوده و همین‌جا اعلام می‌شود.
          </p>

          <div style={label}>شفافیت · Transparenz</div>
          <p style={note}>
            برآورد نیاز سالانهٔ گاهنامهٔ گوسان و اندیشکدهٔ فرهنگ و هنر گوسان در فاز اول حدود ۶۵ هزار یورو است: نزدیک به ۳۷ درصد آن به عنوان قلم‌بها به نویسندگان و پژوهشگران می‌رسد؛ حدود ۲۲ درصد دستمزد تحریریه و مدیریت است؛ حدود ۲۲ درصد هزینه‌های پشتیبانی، ویرایش و ترجمه؛ و تنها حدود ۴ درصد هزینه‌های فنی (میزبانی و ابزارها). باقی، اندوختهٔ احتیاطی است. گوسان برنامهٔ مالی پانزده‌سالهٔ خود را در سه مرحله تعریف کرده است؛ رشد هر مرحله تنها بر پایهٔ منابع پایدار به‌دست‌آمده آغاز می‌شود و هزینه‌های ثابت هرگز از درآمد پایدار پیشی نمی‌گیرند. گوسان هر سال گزارشی از منابع و مصارف خود منتشر می‌کند؛ نام هیچ حامی بی‌خواست او برده نمی‌شود.
          </p>
