    ...
    <main data-screen-label="حمایت از گوسان">
      ...
      <div className="wrap" style={{ maxWidth: '760px', paddingBottom: '5rem' }}>
        <Reveal>
          ...
          <p style={para}>
            آنچه گوسان منتشر می‌کند بر همگان گشوده است و پشتیبانی در آن حق و امتیازی پدید نمی‌آورد. پشتیبانی از فعالیت‌های گاهنامه و اندیشکده، سهم داشتن در ماندگاری این نهاد است، و گوسان این همراهی را از یاد نمی‌برد.
          </p>
          ...
          {/* the gold frame made a legal note shout; the house divider carries it */}
