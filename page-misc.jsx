    ...
    <main data-screen-label="حمایت از گوسان">
      ...
      <div className="wrap" style={{ maxWidth: '760px', paddingBottom: '5rem' }}>
        <Reveal>
          ...
          <p style={para}>
            موفقیت و ماندگاری هر نهاد فرهنگی و پژوهشی را همواره حلقه‌ای از یاران آن نهاد امکان‌پذیر ساخته است.
          </p>
          <p style={para}>
