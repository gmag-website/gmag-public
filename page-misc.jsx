  ...
  return (
    <main data-screen-label="حمایت از گوسان">
      ...
      <div className="wrap" style={{ maxWidth: '760px', paddingBottom: '5rem' }}>
        <Reveal>
          <p style={para}>
            تداوم و بهبود فعالیت‌های گوسان تنها با پشتیبانی خوانندگان آن ممکن است. قلم‌بهای نویسندگان و پژوهشگران، دستمزد تحریریه و هزینه‌های فنی، همه از همین راه تأمین می‌شود. گوسان آگهی و بودجهٔ نهادی نمی‌پذیرد؛ حامیان در محتوا دستی ندارند و محتوای گوسان را همراه با همگان، پس از انتشار می‌خوانند.
          </p>
