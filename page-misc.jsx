    ...
    <main data-screen-label="حمایت از گوسان">
      ...
      <div className="wrap" style={{ maxWidth: '760px', paddingBottom: '5rem' }}>
        <Reveal>
          ...
          <p style={para}>
            آنچه گوسان منتشر می‌کند بر همگان گشوده است و پشتیبانی، امتیازی برای کسی به همراه ندارد. پشتیبانی از فعالیت‌های گاهنامه و اندیشکده، سهم داشتن در ماندگاری این نهاد است، و گوسان این همراهی را از یاد نمی‌برد.
          </p>
