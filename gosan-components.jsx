...
const GOSAN_POSTS = [
  ...
  /* «فهرستی از اصطلاحات موسیقایی در متون مانوی» (manichaean-music-terms، احمدرضا
     قائم‌مقامی) به دستور سردبیر (۲۰۲۶-۰۹-۱۹) فعلاً از سیاههٔ سایت برداشته شد —
     «بعداً منتشر می‌شود». مانند voice-of-the-council فقط همین سطر برداشته شده:
     متن، چکیده، جلد، content-overrides، پروف و کارت اشتراک همگی سر جای خود
     هستند؛ بازگرداندن آن = برگرداندن همین سطر + همان slug در features (page-home).
  */
