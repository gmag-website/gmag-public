...
const GOSAN_POSTS = [
  ...
  { slug: 'between-two-defeats', tag: 'پروندهٔ سیاست‌گذاری فرهنگی', title: 'میانِ دو شکست: دولت، بازار و سیاست‌گذاری فرهنگی در ایران (بخش نخست)', excerpt: 'چرا فرهنگ را نه می‌توان به بازار سپرد و نه به دولت مداخله‌گر؟ نخستین یادداشت از مجموعه‌ای دربارهٔ سیاست‌گذاری فرهنگی در ایرانِ آزادِ آینده.', date: 'تابستان ۲۵۸۵', author: 'یلدا زمانی' },
